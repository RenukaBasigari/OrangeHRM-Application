   ...
   import org.openqa.selenium.chrome.ChromeDriver;
      ...
      public class TsrtcHeaderBlockScreenshotes {
...
// Performing a click Operation on the Element of the Header Block
    ...
    File currentWebPageScreenShot=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
     FileUtils.copyFile(currentWebPageScreenShot, new File("./TSRTC_HeaderBlockSceenShots/"+tsrtc_HeaderBlockLinkName+".png"));
